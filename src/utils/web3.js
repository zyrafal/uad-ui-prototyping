...
export const startLpStream = async (pooladdress, amount) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pooladdress);
...
export const releasableAmount = async (dao) => {
  const account = await checkConnectedAndGetAddress();
  const daoContract = new window.web3.eth.Contract(daoAbi, dao);
  return await daoContract.methods.releasableAmount(account).call();
};

export const streamTimeleft = async (dao) => {
  const account = await checkConnectedAndGetAddress();
  const daoContract = new window.web3.eth.Contract(daoAbi, dao);
  return await daoContract.methods.streamTimeleft(account).call();
};

export const unreleasedAmount = async (dao) => {
  const account = await checkConnectedAndGetAddress();
  const daoContract = new window.web3.eth.Contract(daoAbi, dao);
  return await daoContract.methods.unreleasedAmount(account).call();
};
...
export const releasableLpAmount = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.releasableLpAmount(account).call();
};

export const streamLpTimeleft = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.streamLpTimeleft(account).call();
};

export const unreleasedLpAmount = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.unreleasedLpAmount(account).call();
};
...
export const releasableRewardAmount = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.releasableRewardAmount(account).call();
};

export const streamRewardTimeleft = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.streamRewardTimeleft(account).call();
};

export const unreleasedRewardAmount = async (pool) => {
  const account = await checkConnectedAndGetAddress();
  const poolContract = new window.web3.eth.Contract(poolAbi, pool);
  return await poolContract.methods.unreleasedRewardAmount(account).call();
};
