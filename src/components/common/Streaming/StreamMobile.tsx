...
import SettingModalMobile from "../SettingModal/SettingModalMobile";
import ModalTitle from "../SettingModal/ModalTitle";
import ModalBtn from "../SettingModal/ModalBtn";
import "../../NavBar/fade.css";

type StreamMobileProps = {
...
function StreamMobile({
  ...
  useEffect(() => {
    const updateStreamingInfo = async () => {
      ...
      if (totalLeftTime === 0) {
        setWidth((100 * (unreleasedValue - releasableValue)) / unreleasedValue);
  ...
  return (
    <>
      ...
      >
        <div>
          <SettingModalMobile onClose={setStreamSetting} bgColor="#060606">
            <ModalTitle>
              <p>Streaming</p>
              <p>settings</p>
            </ModalTitle>
